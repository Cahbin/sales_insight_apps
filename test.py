...
st.write(f' {angka_pertama} x Angka kedua {angka_kedua} = {operasi_matematika}')
st.write(f' {angka_pertama} + Angka kedua {angka_kedua} = {tambah}')
st.write(f' {angka_pertama} - Angka kedua {angka_kedua} = {kurang}')
st.write(f' {angka_pertama} / Angka kedua {angka_kedua} = {bagi}')